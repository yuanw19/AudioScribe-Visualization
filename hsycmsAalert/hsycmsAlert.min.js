...
hsycmsalert_alert_html += "    <button type=\"button ok\">是</button>";
...
hsycmsalert_confirm_html += "   <div class=\"hsycms-model-text\">是要操作？</div>";
hsycmsalert_confirm_html += "   <div class=\"hsycms-model-btn\">";
hsycmsalert_confirm_html += "    <button type=\"button\" class=\"cancel\">否</button>";
hsycmsalert_confirm_html += "    <button type=\"button\" class=\"ok\">是</button>";
